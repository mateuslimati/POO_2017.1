...
rem set ASTAH_HOME=c:\Program Files\ASTAH-Professional
...
set JAVA_OPTS=-Xms%INITIAL_HEAP_SIZE% -Xmx%MAXIMUM_HEAP_SIZE% -Dsun.java2d.d3d=false
...
echo or edit astah-pro.bat to set ASTAH_HOME.
echo.
pause
goto end
...
echo.
echo If you would like to run java in your specified folder, you can edit astah-pro.bat
echo in %ASTAH_HOME%
